...
from pyenzyme.v1.enzymeml.core.enzymereaction import EnzymeReaction, ReactionElement
from pyenzyme.v1.enzymeml.models.kineticmodel import KineticModel, KineticParameter
from pyenzyme.v1.enzymeml.core.ontology import DataTypes, EnzymeMLPart, SBOTerm
from pyenzyme.v1.enzymeml.core.abstract_classes import (
...
class EnzymeMLReader:
    ...
    def _getUnits(self, model: libsbml.Model) -> Dict[str, UnitDef]:
        ...
        for unit in unitdef_list:
            ...
            for baseunit in unit.getListOfUnits():
                ...
                unitdef._enzmldoc = self.enzmldoc
    ...
    def _getGlobalParameters(self, model: libsbml.Model, enzmldoc):
        ...
        for parameter in parameters:
            ...
            parameter._enzmldoc = self.enzmldoc  # type: ignore
    ...
    def _parse_parameter(self, parameter, enzmldoc):
        ...
        nu_param._enzmldoc = self.enzmldoc  # type: ignore
    ...
    def _parseListOfFiles(
        ...
        return {
            ...
            for file in self._get_element(data_annotation, "files")  # type: ignore
        }
    ...
    def _parseListOfFormats(self, data_annotation: ET.Element) -> Dict[str, List[dict]]:
        ...
        return {
            ...
            for format in self._get_element(data_annotation, "formats")  # type: ignore
        }
    ...
    def _parseMeasurement(
        ...
        measurement_object._temperature_unit_id = temperature_unit_id  # type: ignore
        measurement_object._enzmldoc = self.enzmldoc  # type: ignore
