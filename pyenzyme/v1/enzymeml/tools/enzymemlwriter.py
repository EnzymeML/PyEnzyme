...
from pyenzyme.v1.enzymeml.core.abstract_classes import AbstractSpecies
...
class EnzymeMLWriter:
    ...
    def toFile(self, enzmldoc, path: str, name: Optional[str] = None):
        ...
        # Write to OMEX
        self._createArchive(enzmldoc, paths, name)  # type: ignore
    ...
    def _createArchive(self, enzmldoc, listofPaths, name: Optional[str] = None):
        ...
        out_path = os.path.join(self.path, out_file)  # type: ignore
